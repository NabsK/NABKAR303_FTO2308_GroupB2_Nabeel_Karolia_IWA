...
const createHtml = (athlete) => {
  ...
  let { date, time } = athlete.races.reverse();
  date = new Date(athlete.races[0].date);

  time = athlete.races[0].time;
  ...
  let total = time[0] + time[1] + time[2] + time[3];
  ...
  list.innerHTML = /* html */ `
      ...
      <dd>Total Races: ${races.length}</dd>
